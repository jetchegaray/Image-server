...
exports.handler = async (event) => {
	...
	if (e.code == "NoSuchKey"){
	        return {
                    statusCode: 301,
                    headers: {"Location" : `${URL}/images-default/commerce.png`}
                };
            if (path.includes("users")){
                return {
                    statusCode: 301,
                    headers: {"Location" : `${URL}/images-default/driver.png`}
                };    
            }
	    if (path.includes("coupons")){
                return {
                    statusCode: 301,
                    headers: {"Location" : `${URL}/images-default/cupon.png`}
                };    
            }
            return {
                statusCode: 301,
                headers: {"Location" : `${URL}/images-default/product.png`}
            };
        }
